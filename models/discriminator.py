...
from models.vit_utils import make_vit_backbone, forward_vit
from models.DiffAugment import DiffAugment
from utils.util_net import reload_model_
...
class DINO(torch.nn.Module):
    def __init__(self, hooks = [2,5,8,11], hook_patch: bool = True):
        super().__init__()
        ...
        reload_model_(self.model, torch.load('dinov2/dino_deitsmall16_pretrain.pth'))
